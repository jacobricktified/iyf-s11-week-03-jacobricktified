...
Use terminal commands only to answer the following questions about the portfolio project.
...
The following files contain the word **"contact"**:
...
```text
73  Select-String -Pattern "contact" -Path devtools-exploration.md
74  Select-String -Pattern "contact" -Path README.md
75  ls
76  cd ..
77  .\iyf-s11-week-02-jacobricktified\
78  cd .\iyf-s11-week-02-jacobricktified\
79  ls
80  wc -l .\styles.css
81  (Get-Content styles.css).Count
82  history
```
